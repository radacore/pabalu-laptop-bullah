...
const CategoriesCreate = () => {
    ...
    function submit(event: React.FormEvent) {
        ...
        form.post('/master-data/categories');
    }
                ...
                <header className="flex items-end justify-between">
                    <div>
                        ...
                        <p className="mt-1.5 text-sm text-slate-500">
                            Tambahkan kategori produk baru ke daftar referensi
                        </p>
                    </div>
...
CategoriesCreate.layout = (page: ReactNode) => (
    <AppLayout
        breadcrumbs={[
            { title: 'Dashboard', href: dashboard() },
            { title: 'Data Master', href: '/master-data' },
            { title: 'Kategori', href: '/master-data/categories' },
            { title: 'Tambah', href: '/master-data/categories/create' },
        ]}
    >
        {page}
    </AppLayout>
