...
const TransactionCategoriesCreate = () => {
    const form = useForm({
        name: '',
    ...
    return (
        <>
            <Head title="Tambah Kategori Transaksi" />
                ...
                <header className="flex items-end justify-between">
                    <div>
                        ...
                        <p className="mt-1.5 text-sm text-slate-500">
                            Tambahkan kategori pemasukan atau pengeluaran baru
                        </p>
                    </div>
...
TransactionCategoriesCreate.layout = (page: ReactNode) => (
    <AppLayout
        breadcrumbs={[
...
export default TransactionCategoriesCreate;
