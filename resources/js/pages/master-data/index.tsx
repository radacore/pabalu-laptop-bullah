        ...
        <>
            ...
            <div className="mx-auto max-w-7xl space-y-8 p-6">
                ...
                <header className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
                    <div>
                        <h2 className="text-3xl font-extrabold tracking-tight text-slate-900">Data Master</h2>
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                    <div className="rounded-lg border border-slate-200 bg-white p-4">
                        <div className="text-sm font-medium text-slate-600">Total Grup</div>
                        <div className="mt-1 text-2xl font-bold text-slate-900">{totals.groups}</div>
                    </div>
                    <div className="rounded-lg border border-slate-200 bg-white p-4">
                        <div className="text-sm font-medium text-slate-600">Total Item</div>
                        <div className="mt-1 text-2xl font-bold text-slate-900">{totals.items}</div>
                    </div>
                </div>
