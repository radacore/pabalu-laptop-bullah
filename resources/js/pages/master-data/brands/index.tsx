...
const BrandsIndex = ({ brands, filters }: BrandsIndexProps) => {
...
setToDelete(null);
                    ...
                    description={
                        toDelete
                            ? `Aksi ini tidak dapat dibatalkan. Merek "${toDelete.name}" akan dihapus permanen.`
                            : ''
                    }
                />
            </div>
...
BrandsIndex.layout = (page: ReactNode) => (
    <AppLayout
        breadcrumbs={[
            { title: 'Dashboard', href: dashboard() },
            { title: 'Data Master', href: '/master-data' },
            { title: 'Merek', href: '/master-data/brands' },
        ]}
    >
        {page}
    </AppLayout>
