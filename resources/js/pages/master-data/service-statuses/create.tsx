...
const ServiceStatusesCreate = () => {
    ...
    function submit(event: React.FormEvent) {
        ...
        form.post('/master-data/service-statuses');
    }

    return (
        <>
            <Head title="Tambah Status Servis" />
            <div className="mx-auto flex max-w-3xl flex-col gap-6 p-6">
                <header className="flex items-end justify-between">
                    <div>
                        <h2 className="text-3xl font-extrabold tracking-tight text-slate-900">
                            Tambah Status Servis
                        </h2>
                        <p className="mt-1.5 text-sm text-slate-500">
                            Tambahkan tahapan alur kerja servis baru
                        </p>
                    </div>
...
ServiceStatusesCreate.layout = (page: ReactNode) => (
    <AppLayout
        breadcrumbs={[
            { title: 'Dashboard', href: dashboard() },
            { title: 'Data Master', href: '/master-data' },
            { title: 'Status Servis', href: '/master-data/service-statuses' },
            { title: 'Tambah', href: '/master-data/service-statuses/create' },
        ]}
    >
        {page}
    </AppLayout>
...
export default ServiceStatusesCreate;
