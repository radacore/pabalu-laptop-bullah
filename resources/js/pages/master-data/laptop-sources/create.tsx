...
const LaptopSourcesCreate = () => {
    ...
    function submit(event: React.FormEvent) {
        ...
        form.post('/master-data/laptop-sources');
    }

    return (
        <>
            <Head title="Tambah Sumber Laptop" />
            <div className="mx-auto flex max-w-3xl flex-col gap-6 p-6">
                <header className="flex items-end justify-between">
                    <div>
                        <h2 className="text-3xl font-extrabold tracking-tight text-slate-900">
                            Tambah Sumber Laptop
                        </h2>
                        <p className="mt-1.5 text-sm text-slate-500">
                            Tambahkan asal perolehan unit baru
                        </p>
                    </div>
...
LaptopSourcesCreate.layout = (page: ReactNode) => (
    <AppLayout
        breadcrumbs={[
            { title: 'Dashboard', href: dashboard() },
            { title: 'Data Master', href: '/master-data' },
            { title: 'Sumber Laptop', href: '/master-data/laptop-sources' },
            { title: 'Tambah', href: '/master-data/laptop-sources/create' },
        ]}
    >
        {page}
    </AppLayout>
...
export default LaptopSourcesCreate;
