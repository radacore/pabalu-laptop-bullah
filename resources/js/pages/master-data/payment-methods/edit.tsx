...
const PaymentMethodsEdit = ({ paymentMethod }: PaymentMethodsEditProps) => {
    const form = useForm({
    ...
    function submit(event: React.FormEvent) {
        ...
        form.put(`/master-data/payment-methods/${paymentMethod.id}`);
    }
                ...
                <header className="flex items-end justify-between">
                    <div>
                        ...
                        <p className="mt-1.5 text-sm text-slate-500">
                            Perbarui detail cara pembayaran
                        </p>
                    </div>
...
PaymentMethodsEdit.layout = (page: ReactNode) => (
    <AppLayout
        breadcrumbs={[
