...
import {
    edit as websiteSettingsEdit,
    update as websiteSettingsUpdate,
} from '@/routes/website-settings';
            ...
            <form onSubmit={submit} className="mx-auto max-w-7xl space-y-6 p-6">
                <header className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
                    <div>
                        ...
                        <p className="mt-1 text-sm text-slate-500">
                            Konfigurasi identitas, kontak, jam buka, dan tautan
                            sosial yang ditampilkan di halaman publik.
                        </p>
                    </div>
                </header>
                ...
                <div className="grid gap-6 lg:grid-cols-2">
                    ...
                    >
                        <div className={inputGroup}>
                            ...
                            <Input
                                ...
                                onChange={(e) =>
                                    form.setData('website_name', e.target.value)
                                }
                                required
                                maxLength={120}
                            />
                    ...
                    <SectionCard
                        icon={Phone}
                        title="Kontak"
                        description="Alamat workshop, WhatsApp, telepon, dan email."
                    >
                        <div className={inputGroup}>
                        ...
                        <div className={inputGroup}>
                            ...
                            />
                            <p className="text-xs text-slate-500">
                                Format internasional (awalan 62). Dipakai untuk
                                tombol WhatsApp di halaman publik.
                            </p>
                    ...
                    <SectionCard
                        ...
                        description="Teks bebas untuk ditampilkan di halaman kontak."
                    >
                        <div className={inputGroup}>
                            <Label htmlFor="operational_hours_weekday">
                                Hari Kerja
                            </Label>
                            <Input
                            ...
                            />
                            <InputError
                                message={form.errors.operational_hours_weekday}
                            />
                        </div>

                        <div className={inputGroup}>
                            <Label htmlFor="operational_hours_weekend">
                                Akhir Pekan
                            </Label>
                            <Input
                            ...
                            />
                            <InputError
                                message={form.errors.operational_hours_weekend}
                            />
                        </div>
                    </SectionCard>
                    ...
                    >
                        <div className={inputGroup}>
                            ...
                            />
                            <p className="text-xs text-slate-500">
                                Buka Google Maps → Share → Embed a map → salin
                                URL di atribut{' '}
                            ...
                            <InputError
                                message={form.errors.google_maps_embed}
                            />
                        </div>
                    ...
                    <SectionCard
                        icon={LinkIcon}
                        title="Tautan Sosial"
                        description="URL lengkap (opsional). Kosongkan untuk menyembunyikan."
                    >
                        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            <div className={inputGroup}>
                                <Label
                    ...
                    >
                        <div className={inputGroup}>
                            ...
                            />
                            <InputError
                                message={form.errors.footer_description}
                            />
                        </div>
                    </SectionCard>
                </div>
